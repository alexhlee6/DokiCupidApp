...
profile2 = Profile.create(user_id: (user2.id), fname: "Alex", zipcode: 92122, bio: "Hi I'm Alex, the creator of this app!", identify_as: "Female", looking_for: "Friends", compatibility_answers: "YNNYYNYY")
profile2.photo.attach(io: file2, filename: "akko.jpg")